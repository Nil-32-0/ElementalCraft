package metafact.elementalcraft.spell.fire;
...
public class FireBallSpell extends Spell {
	...
	public @Nonnull InteractionResult castOnSelf(@Nonnull Entity caster) {
		...
		LargeFireball fireballentity = new LargeFireball(caster.level(), (LivingEntity) caster, vec3d.x * 100, vec3d.y * 100, vec3d.z * 100, Math.round(getStrength()));
