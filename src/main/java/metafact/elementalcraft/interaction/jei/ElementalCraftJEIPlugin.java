...
import metafact.elementalcraft.interaction.jei.category.PureInfusionRecipeCategory;
import metafact.elementalcraft.interaction.jei.category.SpellCraftRecipeCategory;
import metafact.elementalcraft.interaction.jei.category.element.CrystalThrowingRecipeCategory;
import metafact.elementalcraft.interaction.jei.category.element.DisplacementRecipeCategory;
import metafact.elementalcraft.interaction.jei.category.element.EvaporationRecipeCategory;
import metafact.elementalcraft.interaction.jei.category.element.ExtractionRecipeCategory;
import metafact.elementalcraft.interaction.jei.category.element.SolarSynthesisRecipeCategory;
...
import metafact.elementalcraft.interaction.jei.category.instrument.io.mill.SawingRecipeCategory;
import metafact.elementalcraft.interaction.jei.category.instrument.io.ToolInfusionRecipeCategory;
import metafact.elementalcraft.interaction.jei.category.shrine.BuddingShrineRecipeCategory;
import metafact.elementalcraft.interaction.jei.category.shrine.MeltingShrineRecipeCategory;
import metafact.elementalcraft.interaction.jei.category.shrine.SpringShrineRecipeCategory;
import metafact.elementalcraft.interaction.jei.ingredient.ECIngredientTypes;
import metafact.elementalcraft.interaction.jei.ingredient.element.ElementIngredientHelper;
import metafact.elementalcraft.interaction.jei.ingredient.element.ElementIngredientRenderer;
...
import metafact.elementalcraft.interaction.jei.ingredient.source.SourceIngredientHelper;
import metafact.elementalcraft.interaction.jei.ingredient.source.SourceIngredientRenderer;
    ...
    private List<EnchantmentLiquefactionRecipeCategory.RecipeWrapper> getEnchantmentLiquefactionRecipes(@Nonnull IRecipeRegistration registry) {
        ...
        return ForgeRegistries.ENCHANTMENTS.getValues().stream()
                .flatMap(e -> IntStream.range(1, e.getMaxLevel())
                        .mapToObj(l -> new EnchantmentLiquefactionRecipeCategory
                                .RecipeWrapper(new EnchantmentLiquefactionRecipe(ElementalCraftApi.createRL("liquefier"), e), l, stacks.stream()
