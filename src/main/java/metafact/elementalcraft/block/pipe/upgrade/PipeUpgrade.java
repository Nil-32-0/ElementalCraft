package metafact.elementalcraft.block.pipe.upgrade;
...
import metafact.elementalcraft.api.element.transfer.path.IElementTransferPath;
...
import metafact.elementalcraft.block.pipe.ConnectionType;
import metafact.elementalcraft.block.pipe.ElementPipeBlockEntity;
import metafact.elementalcraft.block.pipe.ElementPipeTransferer;
import metafact.elementalcraft.block.pipe.upgrade.type.PipeUpgradeType;
import metafact.elementalcraft.loot.parameter.ECLootContextParamSets;
import metafact.elementalcraft.loot.parameter.ECLootContextParams;
