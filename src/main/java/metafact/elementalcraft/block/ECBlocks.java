...
import metafact.elementalcraft.block.anchor.TranslocationAnchorBlock;
import metafact.elementalcraft.block.container.ElementContainerBlock;
import metafact.elementalcraft.block.container.SmallElementContainerBlock;
import metafact.elementalcraft.block.container.creative.CreativeElementContainerBlock;
import metafact.elementalcraft.block.container.reservoir.ReservoirBlock;
import metafact.elementalcraft.block.diffuser.DiffuserBlock;
import metafact.elementalcraft.block.evaporator.EvaporatorBlock;
import metafact.elementalcraft.block.extractor.ExtractorBlock;
import metafact.elementalcraft.block.extractor.RudimentaryElementExtractorBlock;
import metafact.elementalcraft.block.extractor.ImprovedExtractorBlock;
import metafact.elementalcraft.block.instrument.binder.BinderBlock;
import metafact.elementalcraft.block.instrument.binder.improved.ImprovedBinderBlock;
import metafact.elementalcraft.block.instrument.crystallizer.CrystallizerBlock;
import metafact.elementalcraft.block.instrument.enchantment.liquefier.EnchantmentLiquefierBlock;
import metafact.elementalcraft.block.instrument.infuser.InfuserBlock;
import metafact.elementalcraft.block.instrument.inscriber.InscriberBlock;
import metafact.elementalcraft.block.instrument.io.firefurnace.FireFurnaceBlock;
import metafact.elementalcraft.block.instrument.io.firefurnace.blast.FireBlastFurnaceBlock;
import metafact.elementalcraft.block.instrument.io.mill.grindstone.air.AirMillGrindstoneBlock;
import metafact.elementalcraft.block.instrument.io.mill.grindstone.water.WaterMillGrindstoneBlock;
import metafact.elementalcraft.block.instrument.io.mill.woodsaw.air.AirMillWoodSawBlock;
import metafact.elementalcraft.block.instrument.io.mill.woodsaw.water.WaterMillWoodSawBlock;
import metafact.elementalcraft.block.instrument.io.purifier.PurifierBlock;
import metafact.elementalcraft.block.pipe.ElementPipeBlock;
import metafact.elementalcraft.block.pureinfuser.PureInfuserBlock;
...
import metafact.elementalcraft.block.shrine.breeding.BreedingShrineBlock;
import metafact.elementalcraft.block.shrine.budding.BuddingShrineBlock;
import metafact.elementalcraft.block.shrine.enderlock.EnderLockShrineBlock;
import metafact.elementalcraft.block.shrine.firepylon.FirePylonBlock;
import metafact.elementalcraft.block.shrine.grove.GroveShrineBlock;
import metafact.elementalcraft.block.shrine.growth.GrowthShrineBlock;
import metafact.elementalcraft.block.shrine.harvest.HarvestShrineBlock;
import metafact.elementalcraft.block.shrine.melting.MeltingShrineBlock;
import metafact.elementalcraft.block.shrine.lumber.LumberShrineBlock;
import metafact.elementalcraft.block.shrine.ore.OreShrineBlock;
import metafact.elementalcraft.block.shrine.overload.OverloadShrineBlock;
import metafact.elementalcraft.block.shrine.spawning.SpawningShrineBlock;
import metafact.elementalcraft.block.shrine.spring.SpringShrineBlock;
import metafact.elementalcraft.block.shrine.sweet.SweetShrineBlock;
...
import metafact.elementalcraft.block.shrine.vacuum.VacuumShrineBlock;
import metafact.elementalcraft.block.sorter.SorterBlock;
import metafact.elementalcraft.block.source.SourceBlock;
import metafact.elementalcraft.block.source.breeder.SourceBreederBlock;
import metafact.elementalcraft.block.source.breeder.pedestal.SourceBreederPedestalBlock;
import metafact.elementalcraft.block.source.displacement.plate.BrokenSourceDisplacementPlateBlock;
import metafact.elementalcraft.block.source.displacement.plate.SourceDisplacementPlateBlock;
import metafact.elementalcraft.block.spelldesk.SpellDeskBlock;
import metafact.elementalcraft.block.synthesizer.combustion.CombustionSynthesizerBlock;
import metafact.elementalcraft.block.synthesizer.cracking.CrackingSynthesizerBlock;
import metafact.elementalcraft.block.synthesizer.cracking.SculkCrackingSynthesizerBlock;
import metafact.elementalcraft.block.synthesizer.culinary.CulinarySynthesizerBlock;
import metafact.elementalcraft.block.synthesizer.draining.DrainingSynthesizerBlock;
import metafact.elementalcraft.block.synthesizer.mana.ManaSynthesizerBlock;
import metafact.elementalcraft.block.synthesizer.mill.AirMillSynthesizerBlock;
import metafact.elementalcraft.block.synthesizer.solar.SolarSynthesizerBlock;
import metafact.elementalcraft.block.synthesizer.vibration.VibrationSynthesizerBlock;
