package metafact.elementalcraft.block.synthesizer.mana;
...
public class ManaSynthesizerManaReceiver implements ManaReceiver {
    ...
    public boolean isFull() {
        return this.mana >= ECConfig.SERVER.manaSynthesizerManaCapacity.get();
    }

    @Override
    public void receiveMana(int mana) {
        this.mana = Math.max(0, Math.min(getCurrentMana() + mana, ECConfig.SERVER.manaSynthesizerManaCapacity.get()));
    }
