package metafact.elementalcraft.recipe.instrument.enchantment.liquefaction;
...
import metafact.elementalcraft.recipe.IRuntimeContainerBlockEntityRecipe;
import metafact.elementalcraft.recipe.instrument.AbstractInstrumentRecipe;
import metafact.elementalcraft.recipe.instrument.ILuckRecipe;
...
public class EnchantmentLiquefactionRecipe extends AbstractInstrumentRecipe<EnchantmentLiquefierBlockEntity> implements ILuckRecipe<EnchantmentLiquefierBlockEntity>, IRuntimeContainerBlockEntityRecipe<EnchantmentLiquefierBlockEntity> {
    ...
    public EnchantmentLiquefactionRecipe(ResourceLocation id, Enchantment enchantment) {
