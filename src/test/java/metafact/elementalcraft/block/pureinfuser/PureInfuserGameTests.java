package metafact.elementalcraft.block.pureinfuser;
...
public class PureInfuserGameTests {
    ...
    public static void should_craftPureHolderWithElement(GameTestHelper helper) {
        ...
        helper.startSequence().thenExecute(() -> {
            var fireHolder = new ItemStack(ECItems.ELEMENT_HOLDERS.get(ElementType.FIRE).get());

            fireHolder.getCapability(ElementalCraftCapabilities.ELEMENT_STORAGE).resolve().orElseThrow().fill();
            ...
            waterPedestalItemHandler.insertItem(0, new ItemStack(ECItems.ELEMENT_HOLDERS.get(ElementType.WATER).get()), false);
            earthPedestalItemHandler.insertItem(0, new ItemStack(ECItems.ELEMENT_HOLDERS.get(ElementType.EARTH).get()), false);
            airPedestalItemHandler.insertItem(0, new ItemStack(ECItems.ELEMENT_HOLDERS.get(ElementType.AIR).get()), false);
            ...
            assertThat(pureInfuserItemHandler).satisfies(0, s -> {
                ...
                assertThat(s.getCapability(ElementalCraftCapabilities.ELEMENT_STORAGE).resolve().orElseThrow()).satisfies(es -> {
