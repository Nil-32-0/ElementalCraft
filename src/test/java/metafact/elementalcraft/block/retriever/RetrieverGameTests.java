package metafact.elementalcraft.block.retriever;
...
public class RetrieverGameTests {
    ...
    public static void should_extractFromBinder(GameTestHelper helper) {
        ...
        helper.startSequence().thenExecute(() -> {
            ...
            inv.setItem(4, new ItemStack(ECItems.CRYSTALS.get(ElementType.AIR).get()));
    ...
    public static void should_extractOutputAndRemainingFromBinder(GameTestHelper helper) {
        ...
        helper.startSequence().thenExecute(() -> {
            ...
            inv.setItem(1, new ItemStack(ECItems.CRYSTALS.get(ElementType.FIRE).get()));
