package metafact.elementalcraft.api.range;
...
public record Range(
    ...
    public static class Builder {
        ...
        public Range.Builder expandingUp(double horizontal, double vertical) {
            return box(-horizontal, 0, -horizontal, horizontal + 1, vertical, horizontal + 1);
        }

        public Range.Builder expandingDown(double horizontal, double vertical) {
        ...
        public Range build() {
            return new Range(box, stitch, growthRatio);
        }
    }
}