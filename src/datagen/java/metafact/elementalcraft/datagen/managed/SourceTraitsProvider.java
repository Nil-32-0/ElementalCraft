...
import metafact.elementalcraft.block.source.trait.value.FixedSourceTraitValueProvider;
import metafact.elementalcraft.block.source.trait.value.RangeBasedSourceTraitValueProvider;
import metafact.elementalcraft.block.source.trait.value.StepsSourceTraitValueProvider;
import metafact.elementalcraft.data.predicate.block.RangeFromSpawnPredicate;
