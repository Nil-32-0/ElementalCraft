package metafact.elementalcraft.datagen.recipe;
...
import metafact.elementalcraft.datagen.recipe.builder.MeltingRecipeBuilder;
...
import metafact.elementalcraft.infusion.tool.effect.DodgeToolInfusionEffect;
import metafact.elementalcraft.infusion.tool.effect.FastDrawToolInfusionEffect;
import metafact.elementalcraft.item.ECCreativeModeTabs;
import metafact.elementalcraft.item.ECItems;
import metafact.elementalcraft.item.source.receptacle.NaturalSourceIngredient;
...
//    private final CompletableFuture<TagsProvider.TagLookup<Block>> lookupProvider;
    private final CompletableFuture<HolderLookup.Provider> lookupProvider;

	public ECRecipeProvider(PackOutput pOutput, CompletableFuture<HolderLookup.Provider> provider, ExistingFileHelper exFileHelper) {
		super(pOutput);
    ...
    private void registerMelting(Consumer<FinishedRecipe> consumer) {
        ...
        try {
            lookup = lookupProvider.get().lookupOrThrow(Registries.BLOCK);
        } catch (ExecutionException | InterruptedException e) {
            ElementalCraftApi.LOGGER.error(e);
        }
