package metafact.elementalcraft.datagen.registry.world;
...
import metafact.elementalcraft.datagen.registry.AbstractECRegistryBootstrap;
import metafact.elementalcraft.world.feature.ECFeatures;
import metafact.elementalcraft.world.feature.SourceFeature;
import metafact.elementalcraft.world.feature.config.ElementTypeFeatureConfig;
import metafact.elementalcraft.world.feature.config.IElementTypeFeatureConfig;
import metafact.elementalcraft.world.feature.config.RandomElementTypeFeatureConfig;
import metafact.elementalcraft.world.feature.placement.SourcePlacement;

import java.util.Arrays;
import java.util.List;

public class ECFeaturesProvider extends AbstractECRegistryBootstrap<PlacedFeature> {
    ...
    public ECFeaturesProvider() {
        super(Registries.PLACED_FEATURE);
    }

    @Override
    protected void gather() {
        add("inert_crystal_ore_middle", new PlacedFeature(Holder.direct(new ConfiguredFeature<>(Feature.ORE, new OreConfiguration(List.of(
                OreConfiguration.target(new TagMatchTest(BlockTags.STONE_ORE_REPLACEABLES), ECBlocks.CRYSTAL_ORE.get().defaultBlockState()),
    ...
    private Holder.Reference<PlacedFeature> addSourceNether(String name, RandomElementTypeFeatureConfig config, int chance) {
    ...
    private Holder.Reference<PlacedFeature> addSource(String name, IElementTypeFeatureConfig config, List<PlacementModifier> placement) {
